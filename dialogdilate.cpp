...
void DialogDilate::on_pushButton00_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton01_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton02_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton10_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton11_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton12_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton20_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton21_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_pushButton22_toggled(bool checked)
{
    if (checked) {
...
void DialogDilate::on_buttonBox_accepted()
{
