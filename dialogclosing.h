#ifndef DIALOGCLOSING_H
#define DIALOGCLOSING_H
...
class DialogClosing : public QDialog
{
    Q_OBJECT

public:
    explicit DialogClosing(QWidget *parent = 0);
    ~DialogClosing();
...
signals:
    void sendData(unsigned char structElement[3][3]);

private:
    Ui::DialogClosing *ui;
};

#endif // DIALOGCLOSING_H
